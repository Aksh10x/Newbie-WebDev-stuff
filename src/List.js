...
const List = () => {
    ...
    return (
        ...
        <div className="max-w-[350px] text-white bg-red-500 w-full h-[450px] rounded-xl flex flex-col justify-evenly bg-opacity-90 border-2 border-red-600 backdrop-blur-sm shadow-2xl"> 
